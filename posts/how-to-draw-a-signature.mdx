...
<Info>
    **Vector** 🖋️ graphics use math to render images. **Raster** 👾 graphics use a set of pixels to render images. 
    ...
    Essentially, vector images are composed of *paths* rather than pixels.  This makes vector images scalable, lightweight, and *easy to manipulate*, which is what makes them perfect for this type of animation.
...
<br />
If you haven't used `framer-motion` before this (sorta) mini tutorial, not to worry! I hadn't before building the signature either :sweat_smile:
