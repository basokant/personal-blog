...
export default function Signature({animate, onlyAnimateInView, animateOnHover}: {animate?: boolean, onlyAnimateInView?: boolean, animateOnHover?: boolean}) {
    const controls = useAnimation();
    const ref = useRef(null);
    const inView = useInView(ref, {once: true});
    
    useEffect(() => {
        if (onlyAnimateInView) {
            if (inView) {
                    ...
                    <g transform="matrix(0.174837,0,0,0.0647543,147.191,-21.7912)">
                        {
                            ...
                            <motion.path 
                                ...
                                variants={signature}
                                initial="hidden"
                                animate={onlyAnimateInView? controls: "visible"}
                                transition={{ ease: "easeInOut", duration: 2, delay: 0.5 }}
                                whileTap={animateOnHover ? "hidden" : ""} whileHover={animateOnHover ? "hidden" : ""}
